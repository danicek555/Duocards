...
const FLOATING_CARDS = [
  { word: "bonjour", hint: "ahoj", className: "top-[12%] right-[8%] rotate-[2.5deg]" },
  { word: "ciao", hint: "čau", className: "top-[28%] left-[6%] -rotate-2" },
  { word: "danke", hint: "díky", className: "bottom-[22%] right-[10%] rotate-[-2deg]" },
  { word: "serendipity", hint: "[EN] šťastná náhoda", className: "bottom-[14%] left-[8%] rotate-[2deg]" },
  { word: "Fernweh", hint: "[DE] touha cestovat", className: "top-[48%] right-[4%] rotate-[3deg] hidden xl:flex" },
  { word: "木漏れ日", hint: "[JA] světlo skrz listí", className: "top-[62%] left-[3%] -rotate-[2.5deg] hidden lg:flex" },
] as const;
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      ...
      {FLOATING_CARDS.map((card) => (
        <AuthCardlet key={card.word} {...card} />
      ))}
